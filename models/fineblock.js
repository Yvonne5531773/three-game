...
export const whiteFineblocks = [
	{  //5
		x: -140+thickWidth+2*middleWidth+fineWidth, y: 740, z: 0, rotationX: -1.6, rotationY: rotationY, rotationZ: 0
	},
	{  //6
		x: -140+thickWidth+2*middleWidth+2*fineWidth-offestX, y: 770, z: 0, rotationX: -1.6, rotationY: rotationY, rotationZ: 0
	},
	{  //7
		x: -140+thickWidth+2*middleWidth+3*fineWidth-2*offestX, y: 790, z: 0, rotationX: -1.6, rotationY: rotationY, rotationZ: 0
	},
	{  //8
		x: -140+thickWidth+2*middleWidth+4*fineWidth-3*offestX, y: 870, z: 0, rotationX: -1.6, rotationY: rotationY, rotationZ: 0
	},
	{  //9
